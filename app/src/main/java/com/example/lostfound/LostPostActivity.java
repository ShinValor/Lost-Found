            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    if (postSnapshot.getKey().equals(userId)) {
                        ...
                        LostPostInformation lostPostInformation = new LostPostInformation(userInformation.getName(),title,desc,userInformation.getPhoneNum(),userId);
                        databaseReference = FirebaseDatabase.getInstance().getReference("/LOST");
                        databaseReference.child(title).setValue(lostPostInformation);
                    }
                }
            }
